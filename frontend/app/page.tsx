      ...
      {[
        {
          ...
          features:['Unlimited trip planning','Day-by-day itineraries','Budget breakdown','Travel style customization','PDF itinerary export'],
          cta:'Start free →',
          href:'/auth/signin',
          disabled:false,
        },
        {
          ...
          sub:'per trip export',
          badge:'Coming soon',
          features:['Everything in Free','Hotel & flight suggestions','Offline trip access','Priority planning'],
          cta:'Notify me →',
          href:'#',
          disabled:true,
        },
